            ...
            md:auto-rows-[18rem] mt-12">
                ...
                <div className="flex items-end grid-default-color grid-1">
                    ...
                    <div className="z-10">
                        ...
                        <p className="headtext">Hi I'm Qaim Raza</p>
                       
                        <p className="subtext">From the last year, 
                ...
                <div className="grid-default-color grid-2">
                    ...
                    <div ref = {grid2Container} className="flex items-center justify-center w-full h-full">
                        ...
                        <Card
                            style = {{rotate: "-60deg", top: "60%", left: "45%"}} 
                            text = "SOLID"
                            containerRef={grid2Container}
                        />
                ...
                <div className="grid-black-color grid-3">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">I'm based in Pakistan, and open to 
                            work worldwide.
                        </p>
                ...
                <div className="grid-default-color grid-5">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">
                            I specialize in full-stack web development using variety 
                            of languages, frameworks, and tools that allow me to build
